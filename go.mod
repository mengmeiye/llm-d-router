...
require (
	...
	github.com/llm-d/llm-d-kv-cache v0.8.0-rc.1
...
replace github.com/llm-d/llm-d-kv-cache => github.com/mengmeiye/llm-d-kv-cache v0.8.0-rc.1.0.20260501125039-b3cc0da8fedb
